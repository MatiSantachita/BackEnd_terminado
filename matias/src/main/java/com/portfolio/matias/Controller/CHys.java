...
import com.portfolio.matias.Dto.dtoHys;
import com.portfolio.matias.Entity.hys;
import com.portfolio.matias.Security.Controller.Mensaje;
import com.portfolio.matias.Service.Shys;
...
public class CHys {
    ...
    public ResponseEntity<?> create(@RequestBody dtoHys dtohys) {
        if (dtohys.getNombre() == null || dtohys.getNombre().trim().length() == 0){
